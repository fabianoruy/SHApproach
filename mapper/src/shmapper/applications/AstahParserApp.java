...
public class AstahParserApp {
    ...
    // String packname = "Standards Structural Models";
    ...
    // }
    // }
    // if (ssmpack == null) throw new ParserException("Package not found: " + packname + ".\n");
    //
    ...
    // addResult("Package found: Initiative.\n");
    // }
    // }
    // if (initpack == null) throw new ParserException("Package not found: Initiative.\n");
    //
    // // Get the Domain package (the single subpackage of the "Initiative" package)
    ...
    // addResult("Package found: " + domainpack.getName() + ".\n");
    // }
    //
    // // Get the SEON View package (1)
    ...
    // addResult("Package found: SEON View.\n");
    // break;
    // }
    // }
    // if (seonpack == null) throw new ParserException("Package not found: SEON View.\n");
    //
    // // Get the ISM package (2)
    ...
    // addResult("Package found: Structure (ISM).\n");
    // break;
    // }
    // }
    // if (ismpack == null) throw new ParserException("Package not found: Structure.\n");
    //
    // // Get the Standards Content Models (SCMs) package (3)
    ...
    // }
    // }
    // if (contentpack == null) throw new ParserException("Package not found: Content.\n");
    //
    // // Creating the SH Initiative
    // initiative = new SHInitiative(domainpack.getName(), null, null);
    //
	...
	try {
		...
		if (diagram != null) {
		    String relativePath = File.separator + diagram.getAstahDiagram().getFullName(File.separator)
			    + ".png";
