...
<BODY>
  ...
  <div style="width: 100%; display: inline-block">
    <div style="display: inline-block; width: 60%">
      ...
      Be sure that all packages, classes and diagrams are in the right place.
      <br />
      Try to avoid not used classes and relations. Only the classes appearing in diagrams will be parsed.
      <br />
      Try to stablish all the generalization and whole/part relations. They will be useful for tool advices.
      <br />
